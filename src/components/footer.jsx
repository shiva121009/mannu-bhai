...
const Footer = () => {
  return (
    <footer className="bg-gray-50 border-t mt-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-12 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-10">
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm">
            ...
            <li>
              <Link to="/refund-policy" className="text-gray-600 hover:text-blue-600">Return & Refund Policy</Link>
            </li>
          </ul>
        </div>
        ...
        {/* For Partners + Social + Apps */}
        <div>
          <h3 className="font-semibold text-gray-900 mb-4">For Partners</h3>
          <ul className="space-y-2 text-sm">
            <li>
              <Link to="/register" className="text-gray-600 hover:text-blue-600">Register as a Professional</Link>
            </li>
            <li>
              <Link to="/franchise" className="text-gray-600 hover:text-blue-600">Become Franchise Partner</Link>
            </li>
          </ul>
          ...
          <div className="flex space-x-4">
            {[
              ...
              { href: "https://instagram.com", icon: <FaInstagram />, color: "hover:bg-pink-500" },
              { href: "https://linkedin.com", icon: <FaLinkedinIn />, color: "hover:bg-blue-700" },
              { href: "https://youtube.com", icon: <FaYoutube />, color: "hover:bg-red-600" },
            ].map((s, i) => (
              <a
                key={i}
                href={s.href}
                ...
                className={`w-9 h-9 flex items-center justify-center rounded-full bg-gray-200 text-gray-600 transition ${s.color} hover:text-white`}
              >
                {s.icon}
              </a>
            ))}
      ...
      {/* Copyright */}
      <div className="border-t w-full py-4 text-center text-gray-600 text-xs sm:text-sm">
